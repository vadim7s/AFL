...
my_class.candidates.sort_values(by=['To_Table', 'Strength'],ascending=False,inplace=True)
my_class.candidates.to_csv('candidates.csv')
temp_df = my_class.candidates.groupby('To_Table',as_index=False,sort=False).first()
